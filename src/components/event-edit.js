...
const createCityOptionsTemplate = (cities) => {
  return cities
    .map((city) => {
      return (
...
const createEditTripEventTemplate = (event) => {
  ...
  const cityOptions = createCityOptionsTemplate(CityNames);
  const photoList = createPhotoTemplate(photos);
    ...
    `<form class="trip-events__item  event  event--edit" action="#" method="post">
      ...
      <section class="event__details">
        ...
        <section class="event__section  event__section--destination">
          ...
          <p class="event__destination-description">${caption}</p>
